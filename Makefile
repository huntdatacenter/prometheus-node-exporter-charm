...
CHARM_STORE_URL := cs:~huntdatacenter/prometheus-node-exporter
CHARM_HOMEPAGE := https://github.com/huntdatacenter/prometheus-node-exporter-charm/
CHARM_BUGS_URL := https://github.com/huntdatacenter/prometheus-node-exporter-charm/issues
...
test-xenial: ## Test Xenial bundle
	tox -e test-xenial
